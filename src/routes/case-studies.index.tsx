...
export const Route = createFileRoute("/case-studies/")({
  head: () => ({
    meta: [
      { title: "Case Studies — BHANIXS" },
      { name: "description", content: "Every system BHANIXS has shipped — across AI, blockchain, and spatial computing. Filter by domain." },
      { property: "og:title", content: "Case Studies — BHANIXS" },
      { property: "og:description", content: "Every system BHANIXS has shipped, filterable by domain." },
    ],
  }),
      ...
      <section className="relative pt-44 pb-16">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mt-6 mx-auto max-w-2xl text-lg text-muted-foreground text-pretty">
            Filter by domain. Each case study covers multiple services — tap any card for the full breakdown.
          </p>
        </div>
      </section>
